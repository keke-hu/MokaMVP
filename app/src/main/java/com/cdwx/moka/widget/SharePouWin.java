...
/**
 * Created by KeKe on 2016/7/13.
 * 分享弹框
 */
public class SharePouWin extends PopupWindow {

    public SharePouWin(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
    ...
    private void initView(final Activity context, View.OnClickListener itemsOnClick) {
        ...
        RelativeLayout rl_qq_zone = (RelativeLayout) view.findViewById(R.id.rl_qq_zone);
        rl_qq_zone.setOnClickListener(itemsOnClick);
        RelativeLayout rl_sina = (RelativeLayout) view.findViewById(R.id.rl_sina);
        rl_sina.setOnClickListener(itemsOnClick);
